...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.coupling.models.couplinggraph.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider extends IdentifiedElementItemProvider {
	/**
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						CouplinggraphPackage.Literals.EDGE__SOURCE, true, false, true, null, null, null));
	}
	...
	protected void addDestinationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Edge_destination_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Edge_destination_feature",
								"_UI_Edge_type"),
						CouplinggraphPackage.Literals.EDGE__DESTINATION, true, false, true, null, null, null));
	}
	...
	protected void addSecurityCharacteristicsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Edge_securityCharacteristics_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Edge_securityCharacteristics_feature",
								"_UI_Edge_type"),
						CouplinggraphPackage.Literals.EDGE__SECURITY_CHARACTERISTICS, true, false, true, null, null,
						null));
	}
